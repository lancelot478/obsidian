...
[Google instant play + Unity Asset Bundle (Google asset delivery) | by Vahid Bashiri | Medium](https://medium.com/@vbashiri1995/google-instant-play-unity-asset-bundle-google-asset-delivery-f63e844b77c4)

[出海指南 | 万字详解 Google Play 上架应用标准包格式 AAB – 融云 Blog-融云即时通讯云|实时音视频](https://www.rongcloud.cn/blog/?p=8191)

[Android 开发者  |  Android Developers](https://developer.android.com/guide/playcore/asset-delivery?hl=zh-cn)


### 1.  如果是库的问题，打包的时候就会失败
### 2. google的包的下载更新应该和游戏的热更新逻辑放在一起
### 3. install_time_asset_pack里的资源减小到100M左右， fast_follow_asset_pack1和fast_follow_asset_pack2 分别放一点点资源，几M左右
